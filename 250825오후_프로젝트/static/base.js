...
const hoverElements = document.querySelectorAll('a, input, button, .signup-form input[type="date"], select');
...
const popElements = document.querySelectorAll(
  'footer .pop-avocado, footer .pop-meat, footer .pop-pan, footer .pop-friedegg, footer .pop-fish'
);
